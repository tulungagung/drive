...
!(function (e, t) {
  ...
  if (UI.dark_mode) {
    document.write(
      '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/tulungagung/drive@1.2.7/css/mdui_v3_dark.min.css">'
    );
  } else {
    document.write(
      '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/tulungagung/drive@1.2.7/css/mdui_v3.min.css">'
    );
  }
  if (UI.dark_mode) {
    document.write(
      '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/tulungagung/drive@1.2.7/css/nexmoe_v3_dark.min.css">'
    );
  } else {
    document.write(
      '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/tulungagung/drive@1.2.7/css/nexmoe_v3.min.css">'
    );
  }
  document.write(
    '<script src="//cdn.jsdelivr.net/gh/tulungagung/drive@1.2.7/js/mdui.min.js"></script>'
  );
  document.write(
    '<script src="//cdn.jsdelivr.net/gh/tulungagung/drive@1.2.7/js/flv.min.js"></script>'
  );
  document.write(
    '<script src="//cdn.jsdelivr.net/gh/tulungagung/drive@1.2.7/js/DPlayer.min.js"></script>'
  );
  document.write(
  ...
  <script src="//cdn.jsdelivr.net/gh/tulungagung/drive@1.2.7/js/ace.js"></script>
  <script src="//cdn.jsdelivr.net/gh/tulungagung/drive@1.2.7/js/ext-language_tools.js"></script>
      `;
    $("#content").html(content);
