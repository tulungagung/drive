...
!(function (e, t) {
  ...
  if (UI.dark_mode) {
    document.write(
      '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/tulungagung/drive@1.2.8/css/mdui_v3_dark.min.css">'
    );
  } else {
    document.write(
      '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/tulungagung/drive@1.2.8/css/mdui_v3.min.css">'
    );
  }
  if (UI.dark_mode) {
    document.write(
      '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/tulungagung/drive@1.2.8/css/nexmoe_v3_dark.min.css">'
    );
  } else {
    document.write(
      '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/tulungagung/drive@1.2.8/css/nexmoe_v3.min.css">'
    );
  }
  document.write(
    '<script src="//cdn.jsdelivr.net/gh/tulungagung/drive@1.2.8/js/mdui.min.js"></script>'
  );
  document.write(
    '<script src="//cdn.jsdelivr.net/gh/tulungagung/drive@1.2.8/js/flv.min.js"></script>'
  );
  document.write(
    '<script src="//cdn.jsdelivr.net/gh/tulungagung/drive@1.2.8/js/DPlayer.min.js"></script>'
  );
  document.write(
    ...
    if (UI.credits) {
      ...
      <div style="margin-bottom: 20px" class="mdui-center mdui-text-center">
        <a href="https://s.id/candro" target="_blank">
          <img src="https://img.shields.io/static/v1?label=candro&amp;message=v1.2.8&amp;color=1E89F2&amp;labelColor=374455&amp;logo=codeproject" alt="help me with money">
        </a>
      </div>
      </div>
      `;
  ...
  <script src="//cdn.jsdelivr.net/gh/tulungagung/drive@1.2.8/js/ace.js"></script>
  <script src="//cdn.jsdelivr.net/gh/tulungagung/drive@1.2.8/js/ext-language_tools.js"></script>
      `;
    $("#content").html(content);
