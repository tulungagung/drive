...
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="//rawcdn.githack.com/tulungagung/drive/33e4ae56465642937d591de31728603a63aa391c/css/mdui_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="//rawcdn.githack.com/tulungagung/drive/33e4ae56465642937d591de31728603a63aa391c/css/mdui_v2.min.css">'
  );
}
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="//rawcdn.githack.com/tulungagung/drive/33e4ae56465642937d591de31728603a63aa391c/css/nexmoe_v2_dark.min.csss">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="//rawcdn.githack.com/tulungagung/drive/33e4ae56465642937d591de31728603a63aa391c/css/nexmoe_v2.min.css">'
  );
}
document.write(
  '<script src="//rawcdn.githack.com/tulungagung/drive/33e4ae56465642937d591de31728603a63aa391c/js/mdui.min.js"></script>'
);
document.write(
  '<script src="//rawcdn.githack.com/tulungagung/drive/33e4ae56465642937d591de31728603a63aa391c/js/flv.min.js"></script>'
);
document.write(
  '<script src="//rawcdn.githack.com/tulungagung/drive/33e4ae56465642937d591de31728603a63aa391c/js/DPlayer.min.js"></script>'
);
document.write(
...
<div class="mdui-container">
  ...
  if (UI.credits) {
    ...
    <div style="margin-bottom: 20px" class="mdui-center mdui-text-center">
      <a href="https://github.com/tulungagung/drive" target="_blank">
        <img src="https://img.shields.io/static/v1?label=tulungagung&amp;message=drive&amp;color=1E89F2&amp;labelColor=374455&amp;logo=github" alt="tulungagung - drive">
      </a>
    </div>
    </div>
    `
